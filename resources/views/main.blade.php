  ...
  <div class="flex justify-between">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
              ...
              <li class="relative ">
                ...
                <h3 class="mt-2 text-xs text-center text-white">Voyage</h3>
              </li>
                ...
                <h3 class="mt-2 text-xs text-center text-white">Jeux</h3>
              </li>
                ...
                <h3 class="mt-2 text-xs text-center text-white">Sport</h3>
              </li>
                ...
                <h3 class="mt-2 text-xs text-center text-white">Musique</h3>
              </li>
                ...
                <h3 class="mt-2 text-xs text-center text-white">Films</h3>
              </li>
...
<div class="block md:grid md:grid-flow-row-dense md:grid-cols-3 md:grid-rows-1">
 <div class="col-span-2">
    <div class="pt-10">
<form class="bg-black shadow rounded-lg mb-6 p-4 md:w-3/4">
...
<div class="bg-black shadow rounded-lg mb-6">
            ...
            <div class="text-white text-sm mb-6 mx-3 px-2">Lorem Ipsum is simply dummy ... <span class="text-gray-400">more</span></div>
            <div class="flex justify-start mb-4 border-t border-slate-800">
            ...
            <div class="flex w-full border-t border-slate-800">
                <div class="mt-3 mx-5 flex flex-row text-xs">
                    <div class="flex text-slate-300 font-normal rounded-md mb-2 mr-4 items-center">Comments:<div class="ml-1 text-gray-400 text-ms"> 30</div></div>
                    <div class="flex text-slate-300 font-normal rounded-md mb-2 mr-4 items-center">Views: <div class="ml-1 text-gray-400 text-ms"> 60k</div></div>
                </div>
                <div class="mt-3 mx-5 w-full flex justify-end text-xs">
                    <div class="flex text-slate-300  rounded-md mb-2 mr-4 items-center">Likes: <div class="ml-1 text-gray-400  text-ms"> 120k</div></div>
                </div>
            </div>
...
<card class=" w-96 rounded-lg shadow-lg">
    ...
    <header class="font-bold text-white text-2xl px-5 py-4">
      Who to follow
    </header>
    ...
    <main class="px-5">
      ...
      <content class="grid grid-cols-6">
        ...
        <div class="col-span-3 px-1 font-semibold flex flex-col ">
          <div class="text-sm text-white"> Mbonyintege </div>
          <div class="text-xm text-slate-50 font-light"> @Cpwr</div>
        </div>
  ...
  <div class="max-w-sm rounded-lg overflow-hidden shadow-sm m-4 mt-5">
    ...
    <div class="flex">
        <div class="flex-1">
            ...
            <h2 class="px-4 ml-2 w-48 text-white font-bold ">#Microsoft363</h2>
    ...
    <div class="flex">
        <div class="flex-1">
            ...
            <h2 class="px-4 ml-2 w-48 text-white font-bold ">#HI-Fashion</h2>
    ...
    <div class="flex">
        <div class="flex-1">
            ...
            <h2 class="px-4 ml-2 w-48 text-white font-bold ">#Ferrari</h2>
